...
export const createNotebook = async (values: InsertNotebook) => {
    try { 
        ...
        return { success: true, message: 'Notebook was created successfully'};
    }
    catch (error) {
        console.error((error as Error)?.message);
        return { success: false, message: 'Failed to create notebooks'};
    }
}
...
export const getNotebooks = async () => {
    try {
        ...
        return { success: true, data: allNotebooks };
    } catch (error) {
        console.error((error as Error)?.message);
